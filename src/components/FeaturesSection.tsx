...
function FeaturesSection() {
  return (
    <section className="px-5 flex flex-col gap-20 items-center">
      <div className="max-w-[29.5rem] flex flex-col items-center gap-6 py-6 text-center">
      ...
      <div className="flex flex-col p-[0.625rem] gap-20 max-w-full xl:max-w-[75rem]">
        <div className="flex gap-6 flex-wrap">
          <FeaturesCard
            ...
            icon={<img src={features_icon1} alt="Icon Analytics dashboard" className="h-[3.125rem] w-[3.125rem] shadow-[0px_0px_36.45px_0px_rgba(89,_29,_221,_0.75)] rounded-lg"/>}
          ></FeaturesCard>
          <FeaturesCard
            ...
            icon={<img src={features_icon2} alt="Icon Digital credit token" className="h-[3.125rem] w-[3.125rem] shadow-[0px_0px_36.45px_0px_rgba(149,_37,_201,_0.75);] rounded-lg"/>}
          ></FeaturesCard>
        </div>
        <FeaturesCard
            ...
            icon={<img src={features_icon3} alt="Icon Digital credit token" className="h-[3.125rem] w-[3.125rem] shadow-[0px_0px_36.45px_0px_rgba(201,_37,_171,_0.75)] rounded-lg"/>}
            image={<img src={digit_screen} alt="Digit token screen code" className="rounded-[1.25rem] shadow-[0px_0px_0px_1.17px_rgba(255,_255,_255,_0.1),0px_0px_0px_2.33px_rgba(0,_0,_0,_0.05),0px_-2px_40px_0px_rgba(187,_155,_255,_0.15),0px_-2px_10px_0px_rgba(233,_223,_255,_0.3),_0px_0.58px_0px_0px_rgba(255,_255,_255,_0.5)_inset,_0px_0.5px_0px_0px_rgba(255,_255,_255,_0.5)_inset]"/>}          
          ></FeaturesCard>
      </div>
    </section>
  );
